...
const seedDatabase = async () => {
    ...
    console.log("Total Inserted Bookings:", insertedBookings.length);

    const totalBookingsInDB = await Booking.countDocuments();
    console.log("Total Bookings In MongoDB:", totalBookingsInDB);

    console.log(
      `🎫 Inserted ${insertedBookings.length} randomized dummy bookings.`,
    );
